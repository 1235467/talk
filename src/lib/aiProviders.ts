...
export const AI_PROVIDERS: Record<AiProviderId, AiProviderAdapter> = {
  ...
  custom: { id: 'custom', label: '自定义 OpenAI 兼容接口', stability: 'custom', defaultBaseUrl: '', defaultVersionPath: '/v1', models: 'unknown', tokenParameter: 'max_tokens', responseFormat: 'unknown', temperature: { min: 0, max: 2 }, thinking: 'none', reasoningFields: ['reasoning_content', 'reasoning'], systemRole: 'native' },
}
